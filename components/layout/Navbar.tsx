    ...
    <nav className="bg-cream border-b border-gray-200 sticky top-0 z-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex items-center gap-3 h-14">
          ...
          <div className="hidden sm:flex items-center gap-2">
            <Link href="/blog" className="text-sm text-gray-500 hover:text-gray-700 px-3 py-1.5">
              Blog
            </Link>
            ...
            {session ? (
              ...
              <>
                <button onClick={() => signIn('google')} className="btn-outline">
                  Sign in
                </button>
      ...
      {menuOpen && (
        <div className="sm:hidden bg-white border-t border-gray-100 px-4 py-3 flex flex-col gap-3">
          ...
          <Link href="/blog" className="text-sm text-gray-600" onClick={() => setMenuOpen(false)}>
            Blog
          </Link>
          ...
          {session ? (
            ...
            <div className="flex gap-2">
              <button onClick={() => signIn('google')} className="btn-outline flex-1">
                Sign in
              </button>
              <button onClick={() => signIn('google')} className="btn-primary flex-1">
                Join free
              </button>
            </div>
          )}
