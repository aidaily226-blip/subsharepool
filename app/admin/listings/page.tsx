'use client'
const MOCK_LISTINGS = [
  { id: '1', name: 'Netflix Premium', type: 'Subscription', by: 'Aryan K.', date: 'Mar 15, 2025', status: 'active' },
  { id: '2', name: 'Delhi → Manali Carpool', type: 'Trip', by: 'Sanya M.', date: 'Mar 14, 2025', status: 'active' },
  { id: '3', name: 'ChatGPT Plus Share', type: 'Subscription', by: 'Rohan V.', date: 'Mar 13, 2025', status: 'flagged' },
  { id: '4', name: 'Figma Professional', type: 'Subscription', by: 'Tanvi N.', date: 'Mar 12, 2025', status: 'active' },
]
