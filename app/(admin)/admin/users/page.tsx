...
const MOCK_USERS = [
  ...
  { id:'2', name:'Sanya Mehta', email:'sanya@gmail.com', role:'user', blocked:false, joined:'Mar 5, 2024', listings:2 },
  { id:'3', name:'Rohan Verma', email:'rohan@gmail.com', role:'user', blocked:true, joined:'Feb 20, 2024', listings:1 },
  { id:'4', name:'Tanvi Nair', email:'tanvi@gmail.com', role:'admin', blocked:false, joined:'Jan 10, 2024', listings:6 },
]
            ...
            <tbody>
              {MOCK_USERS.map(user => (
                <tr key={user.id} className="border-b border-gray-50 hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3">
                    <span className={`badge ${user.role === 'admin' ? 'badge-featured' : 'badge-brand'}`}>
                      {user.role}
                    </span>
                  </td>
